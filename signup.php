<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST'){
        ...
        {
            $errs['tel'] = '電話番号は半角2~5桁、1~4桁、4桁で入力してください';
        }
...
<body>
    ...
    <form action="" method="POST">
        <table>
            <tr>
                <td>メールアドレス*</td>
                <td><input type="text" placeholder="例）abc@cde.ac.jp" name="email" value="<?= @$email ?>">
                    <span style="color:red"><?= @$errs['email'] ?></span>
                </td> 
            </tr>
            <tr>
                <td>パスワード（4文字以上）*</td>
                <td><input type="password" minlength="4" name="password" value="<?= @$password ?>">
            ...
            <tr>
                <td>お名前*</td>
                <td><input type="text" placeholder="例）電子太郎" name="membername" value="<?= @$membername ?>">
                    <span style="color:red"><?= @$errs['membername'] ?></span>
                </td>
            </tr>
            <tr>
                <td>郵便番号*</td>
                <td><input type="text" placeholder="例）000-0000" name="zipcode" value="<?= @$zipcode ?>"  pattern="¥d{3}-¥d{4}" title="郵便番号は3桁-4桁でハイフン(-)を入力してください"  >
                    <span style="color:red"><?= @$errs['zipcode'] ?></span>
                </td>
            </tr>
            <tr>
                <td>住所*</td>
                <td><input type="text" placeholder="例）新宿区○○" name="address" value="<?= @$address ?>">
            ...
            <tr>
                <td>電話番号</td>
                <td>
                    <input type="tel" name="tel1" placeholder="03" size="4" value="<?= @$tel1 ?>"> -
                    <input type="tel" name="tel2" placeholder="1234" size="4" value="<?= @$tel2 ?>"> - 
                    <input type="tel" name="tel3" placeholder="5678" size="4" value="<?= @$tel3 ?>">
